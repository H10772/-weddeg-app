...
-- 1. Create is_admin() function FIRST
...
-- 9. Create new policies for categories
...
-- 10. Create new policies for sizes
...
-- 11. Create new policies for products
...
SELECT 'is_admin() function:', is_admin() as is_admin;
SELECT 'Categories:', COUNT(*) as count FROM public.categories;
SELECT 'Sizes:', COUNT(*) as count FROM public.sizes;
SELECT 'Products:', COUNT(*) as count FROM public.products;
